...
public interface TaskEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.neginskiy.ru/TaskEndpoint/taskGetAllRequest", output = "http://endpoint.tm.neginskiy.ru/TaskEndpoint/taskGetAllResponse")
