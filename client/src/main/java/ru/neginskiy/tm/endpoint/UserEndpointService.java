 ...
 * 2019-02-19T13:30:06.889+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "UserEndpointService",
                  wsdlLocation = "http://localhost:1234/UserEndpoint?wsdl",
...
public class UserEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:1234/UserEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:1234/UserEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
