 ...
 * 2019-03-15T12:14:35.780+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "UserEndpointService",
                  wsdlLocation = "http://localhost:8080/task-manager/UserEndpoint?wsdl",
                  targetNamespace = "http://endpoint.tm.neginskiy.ru/")
public class UserEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.tm.neginskiy.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.tm.neginskiy.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/task-manager/UserEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/task-manager/UserEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
