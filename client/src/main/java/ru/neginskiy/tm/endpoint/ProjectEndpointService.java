...
@WebServiceClient(name = "ProjectEndpointService",
                  wsdlLocation = "http://localhost:1234/ProjectEndpoint?wsdl",
...
public class ProjectEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:1234/ProjectEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProjectEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:1234/ProjectEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
