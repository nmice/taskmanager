...
public interface ProjectEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.neginskiy.ru/ProjectEndpoint/projectGetAllRequest", output = "http://endpoint.tm.neginskiy.ru/ProjectEndpoint/projectGetAllResponse")
