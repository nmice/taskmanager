 ...
 * 2019-02-05T16:52:10.680+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "DataEndpointService",
                  wsdlLocation = "http://localhost:8080/DataEndpoint?wsdl",
...
public class DataEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/DataEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DataEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/DataEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
